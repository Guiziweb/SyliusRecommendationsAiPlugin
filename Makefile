...
export COMPOSE_PROJECT_NAME=sylius_recommendations_ai_plugin
PLUGIN_NAME=sylius-recommendations-ai-plugin
COMPOSE=docker compose
YARN=yarn
DOCTRINE_MIGRATIONS_NAMESPACE=Guiziweb\SyliusRecommendationsAiPlugin\Migrations
...
setup_application:
	...
	$(MAKE) apply_dist
	(cd ${APP_DIR} && ${COMPOSER} require --no-progress guiziweb/sylius-recommendations-ai-plugin="*@dev")
